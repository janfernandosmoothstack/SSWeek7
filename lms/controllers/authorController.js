//importing modules - require in js is the same as export in java
var routes = require('express').Router();
var db = require('../dao/db');
var authorDao = require('../dao/authorDao');

//use express to define a get method
//function is required by the definition of the get method
routes.get('/author',function(req,res){

    //allows you to provide the request parameters
    //providing this function as a callback for the db.query function in dao
...
//another way of defining a module
